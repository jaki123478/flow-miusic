...
import { c as getHomeFeed, d as getTrackLyrics, f as getTranslatedLyrics, h as stationToTrack, i as getCountryRadios, l as getRelatedTracks, n as createSsrRpc, p as getVideoTrack, r as getChartTracks, s as getGenreMix, u as getTopRadios } from "./lyrics-BNyLFdmy.mjs";
...
import { t as getAudioUrl } from "./ytmusic.server-BUWalc_p.mjs";
import { $ as Check, A as Play, B as ListPlus, C as RotateCw, D as Radio, E as Repeat1, F as Mic, G as Heart, H as Library, I as MicVocal, J as Download, K as Gauge, L as LogOut, M as Pause, N as Music2, O as QrCode, P as Moon, Q as ChevronDown, R as LogIn, S as Search, T as Repeat, U as Languages, V as ListMusic, W as House, X as Compass, Y as Copy, Z as Clock, _ as Shuffle, a as User, b as Settings, c as Trophy, d as Sun, et as Car, f as Sparkles, g as SkipBack, h as SkipForward, i as Volume2, j as Pen, k as Plus, l as TriangleAlert, m as SlidersVertical, n as VolumeX, o as Upload, p as Smartphone, q as Ellipsis, r as VolumeOff, s as Type, t as X, tt as Bot, v as ShieldCheck, w as RotateCcw, x as Send, y as Share2 } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/share-DCMXincW.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-BKwaTMc9.js
...
var useFlowStore = create((set, get) => ({
	...
	hydrate: () => {
		...
		const profileName = readJson("flow_profile_name", "Flow User");
		const hasSeenOnboarding = readJson("flow_onboarding_done", false);
		const trackMap = {};
	...
	setSleep: (minutes) => set({
		sleepEndsAt: minutes == null ? null : Date.now() + minutes * 6e4,
		sleepEndOfTrack: false
	}),
	setSleepEndOfTrack: (v) => set({
		sleepEndOfTrack: v,
		sleepEndsAt: null
	}),
...
function AudioVisualizer({ className = "", barCount = 32 }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const render = () => {
			...
			phase += .05;
			const barWidth = width / barCount * .7;
			...
			for (let i = 0; i < barCount; i++) {
				...
				if (isPlaying) {
					...
					bar.targetHeight = Math.max(.15, Math.abs(sine) * .85 + noise) * (height * .9);
				} else bar.targetHeight = 3;
				bar.height += (bar.targetHeight - bar.height) * .22;
				const x = i * (barWidth + gap) + gap / 2;
				const y = height - bar.height;
				const grad = ctx.createLinearGradient(0, height, 0, 0);
				grad.addColorStop(0, "rgba(30, 215, 96, 0.4)");
				grad.addColorStop(.5, "rgba(30, 215, 96, 0.95)");
				grad.addColorStop(1, "rgba(56, 189, 248, 1)");
				ctx.fillStyle = grad;
				ctx.beginPath();
				ctx.roundRect(x, y, barWidth, bar.height, [
					4,
					4,
					0,
					0
...
function AudioEngine() {
	...
	(0, import_react.useEffect)(() => {
		...
		if (typeof window !== "undefined") {
			window.__flowAudioPause = () => {
				useFlowStore.getState().pause();
				audioRef.current?.pause();
			};
			window.__flowAudioResume = () => {
				const s = useFlowStore.getState();
				if (s.current) {
					s.resume();
					audioRef.current?.play().catch(() => {});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("audio", {
		...
		onTimeUpdate: (e) => {
			...
			if (el.duration > 0 && (t >= el.duration * .7 || el.duration - t <= 30)) {
				const nxt = st.queue[st.queueIndex + 1];
				if (nxt?.videoId && nxt.videoId !== track?.videoId) prefetchAudio(nxt.videoId);
			}
		},
		onDurationChange: (e) => {
		...
		onError: () => {
			...
			if (blob && audio.src !== blob) applySrc(audio, blob, s.isPlaying, true);
			else if (!audio.src.includes("/api/stream") && id) applySrc(audio, `/api/stream?v=${id}`, s.isPlaying, true);
...
function MiniPlayer() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("now-bar pointer-events-auto bg-elevated/95 md:bg-bg", (!open || showFull) && "is-away"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "md:hidden",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-2.5 mb-1 overflow-hidden rounded-2xl bg-[#14171E]/95 shadow-xl ring-1 ring-white/10 backdrop-blur-xl",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "size-11 shrink-0 overflow-hidden rounded-xl bg-surface shadow-md ring-1 ring-white/10",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackArt, {
								src: current.artwork,
								alt: ""
							})
						...
						type: "button",
						onClick: togglePlay,
						className: "flex size-11 shrink-0 items-center justify-center rounded-full text-primary hover:bg-white/5 active:scale-90 transition-transform",
						"aria-label": "Play",
...
function FullPlayer() {
	...
	const [showTranslate, setShowTranslate] = (0, import_react.useState)(false);
	const [translatedLines, setTranslatedLines] = (0, import_react.useState)([]);
	...
	const [showEqMenu, setShowEqMenu] = (0, import_react.useState)(false);
	const [showCarMode, setShowCarMode] = (0, import_react.useState)(false);
	const [showAudioHud, setShowAudioHud] = (0, import_react.useState)(false);
	...
	const cycleLyricsFontSize = () => {
		...
		const nextSize = sizes[(sizes.indexOf(lyricsFontSize) + 1) % sizes.length];
	...
	const handleTouchEnd = (e) => {
		...
		const diff = (e.changedTouches[0]?.clientX ?? touchStartX) - touchStartX;
		if (Math.abs(diff) > 60) {
			if (diff < 0) next();
			else prev();
		}
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					...
					alt: "",
					referrerPolicy: "no-referrer",
					className: "player-ambient size-full object-cover blur-3xl opacity-45 saturate-200"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0",
					style: { background: glow ? `linear-gradient(180deg, color-mix(in oklab, ${glow} 55%, transparent) 0%, rgb(0 0 0 / 0.6) 40%, rgb(0 0 0 / 0.92) 100%)` : "linear-gradient(180deg, rgb(0 0 0 / 0.35) 0%, rgb(0 0 0 / 0.88) 100%)" }
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative z-10 flex min-h-0 flex-1 flex-col",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-3 mt-1.5 flex items-center justify-between rounded-2xl px-2 py-1 player-glass shadow-lg",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setShowFullPlayer(false),
							className: "flex size-11 items-center justify-center rounded-full hover:bg-elevated/60 active:scale-95 transition-transform",
							"aria-label": "Chiudi",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronDown, { className: "size-6 text-fg" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-primary animate-pulse" }), "Hi-Res · Opus 320k"]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Car, { className: "size-4" })
								}),
								showLyrics && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									type: "button",
									onClick: () => {
										if (showTranslate) {
											setShowTranslate(false);
									...
									className: cn("flex size-10 items-center justify-center rounded-full transition-colors text-xs font-bold", showTranslate ? "text-primary bg-primary/15" : "text-fg/80 hover:text-primary hover:bg-elevated/60"),
					...
					className: "min-h-0 flex-1 overflow-y-auto px-3 pb-8 pt-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "sticky top-0 z-10 mb-3 flex items-center justify-between rounded-2xl px-3.5 py-2.5 player-glass shadow-lg",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: autoplayRelated ? "Autoplay YouTube Music attivo" : "Autoplay disattivato"
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							...
							children: busyQueue ? queueProg || "Salvataggio…" : "Salva tutta la coda"
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "space-y-1",
						children: queue.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackRow, {
							track: t,
							queue,
							index: i,
							showIndex: true
					...
					children: [showLyrics ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						ref: lyricsBox,
						className: "player-glass mx-auto mt-2 min-h-0 w-full max-w-lg flex-1 overflow-y-auto rounded-3xl px-4 py-6 text-center space-y-3.5 shadow-2xl",
						children: lyricsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "size-8 animate-spin rounded-full border-2 border-primary border-t-transparent" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-3 text-base font-bold text-fg",
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("block w-full text-center leading-snug transition-all rounded-xl cursor-pointer select-none", lyricsFontSize === "sm" ? isCur ? "text-lg font-bold py-1.5" : "text-sm py-1" : lyricsFontSize === "lg" ? isCur ? "text-2xl font-extrabold py-3" : "text-lg py-1.5" : lyricsFontSize === "xl" ? isCur ? "text-3xl font-black py-3.5" : "text-xl py-2" : isCur ? "text-xl font-extrabold py-2" : "text-base py-1.5", isCur ? "scale-105 text-primary font-black drop-shadow-md" : i < activeIdx ? "text-fg/80 font-medium" : "text-muted/60 hover:text-fg/90"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "block",
									children: line.text
								}), showTranslate && translatedLines[i] && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "block text-xs font-medium text-emerald-400/90 mt-1 tracking-wide animate-in fade-in duration-200",
									children: translatedLines[i]
								})]
							}, `${line.timeMs}-${i}`);
						})
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AudioVisualizer, { barCount: 28 })
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "player-glass mt-auto rounded-3xl px-5 pt-4 pb-[max(1.1rem,env(safe-area-inset-bottom))] shadow-2xl",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										className: "truncate text-xl font-bold tracking-tight text-fg md:text-2xl",
										children: current.title
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-0.5 truncate text-sm font-medium text-muted",
										children: current.artist
									})]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-1",
									children: [canDownload ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: busyDl,
										onClick: () => {
										...
										"aria-label": "Mi piace",
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: cn("size-6", liked && "fill-current text-primary") })
									})]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									style: { background: `linear-gradient(to right, var(--color-primary) ${progress}%, rgb(255 255 255 / 0.16) ${progress}%)` }
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-1 flex justify-between text-xs tabular-nums text-subtle font-medium",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkipBack, { className: "size-6 fill-current" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: togglePlay,
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkipForward, { className: "size-6 fill-current" })
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => skipBy(10),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-3 flex items-center justify-between border-t border-white/10 pt-2.5 text-xs text-muted",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "relative",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											className: cn("flex items-center gap-1.5 rounded-full bg-elevated/70 px-3 py-1 font-semibold hover:text-fg transition-colors", settings.eqPreset !== "flat" && "text-primary bg-primary/10"),
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlidersVertical, { className: "size-3.5" }), "EQ"]
										}), showEqMenu && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "absolute bottom-9 left-0 z-50 min-w-48 rounded-2xl bg-elevated/95 p-2 shadow-2xl backdrop-blur-xl ring-1 ring-border text-xs space-y-1",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "px-2 py-1 font-bold text-muted uppercase tracking-wider text-[10px]",
												children: "Preset Equalizzatore"
											}), EQ_PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												type: "button",
												onClick: () => {
													patchSettings({
														eqPreset: p.id,
												...
												className: cn("flex w-full items-center justify-between rounded-xl px-2.5 py-1.5 text-left font-medium hover:bg-surface active:bg-primary active:text-primary-fg", settings.eqPreset === p.id && "text-primary font-bold bg-primary/10"),
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: p.label }), settings.eqPreset === p.id && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-3.5 text-primary" })]
											}, p.id))]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											className: cn("flex items-center gap-1.5 rounded-full bg-elevated/70 px-3 py-1 font-semibold hover:text-fg transition-colors", (sleepEndsAt || sleepEndOfTrack) && "text-primary bg-primary/10"),
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "size-3.5" }), sleepEndOfTrack ? "Fine brano" : sleepEndsAt ? "Timer attivo" : "Timer"]
										}), showSleepMenu && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "absolute bottom-9 right-0 z-50 min-w-44 rounded-2xl bg-elevated/95 p-2 shadow-2xl backdrop-blur-xl ring-1 ring-border text-xs space-y-1",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "px-2 py-1 font-bold text-muted uppercase tracking-wider text-[10px]",
													children: "Timer di spegnimento"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													type: "button",
													onClick: () => {
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
													...
													className: cn("block w-full rounded-xl px-2.5 py-1.5 text-left font-medium hover:bg-surface", sleepEndOfTrack && "text-primary font-bold bg-primary/10"),
													children: "Al termine del brano 🌙"
												}),
												[
													[15, "15 minuti"],
													[30, "30 minuti"],
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Radio, { className: "size-3.5" }), "Radio"]
									})
								]
							})
						]
			...
			showAudioHud && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "size-5 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
									className: "font-heading text-sm font-bold uppercase tracking-wider text-fg",
									children: "Flow Hi-Fi Audio Engine"
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => setShowAudioHud(false),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Codec Audio"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-primary",
										children: "Opus 48kHz (Stream Hi-Fi)"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Bitrate Massimo"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-fg",
										children: "320 kbps VBR Lossless Container"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Profondità Campionamento"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-fg",
										children: "24-bit / 48.000 Hz"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Normalizzazione EBU R128"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-emerald-400",
										children: "Attiva (-14 LUFS)"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Preset Equalizzatore DSP"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold text-primary uppercase",
										children: settings.eqPreset
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex justify-between rounded-xl bg-surface/60 p-2.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-muted",
										children: "Crossfade Intelligente"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										className: "font-bold text-fg",
										children: [settings.crossfade, " secondi"]
									})]
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-4 rounded-xl bg-primary/10 p-3 text-center text-[11px] text-primary font-medium",
							children: "✨ Motore DSP Web Audio a bassissima latenza con buffering dinamico"
						})
					]
				})
			}),
			showCarMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "fixed inset-0 z-50 flex flex-col justify-between bg-black p-6 text-fg animate-in zoom-in-95 duration-200 select-none",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Car, { className: "size-6 text-primary" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-sm font-bold uppercase tracking-widest text-primary",
								children: "Modalità Guida"
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setShowCarMode(false),
							className: "rounded-full bg-surface/80 px-4 py-2 text-xs font-bold text-fg hover:bg-surface",
							children: "Esci dalla Guida"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "size-48 overflow-hidden rounded-3xl bg-surface shadow-2xl ring-2 ring-white/10 mb-6",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackArt, {
									src: current.artwork,
									alt: current.title
								})
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "text-2xl font-black text-fg max-w-sm truncate",
								children: current.title
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-base font-bold text-muted mt-1 max-w-sm truncate",
								children: current.artist
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkipBack, { className: "size-8 fill-current" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: togglePlay,
								...
								children: isPlaying ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "size-12 fill-current" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "size-12 fill-current ml-1" })
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: next,
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkipForward, { className: "size-8 fill-current" })
							})
						]
					})
				]
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex size-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-primary to-emerald-400 text-bg text-2xl font-black shadow-lg shadow-primary/20",
						...
						children: [isEditingName ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								className: "truncate font-heading text-xl font-bold text-fg sm:text-2xl",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "inline-flex items-center gap-1 rounded-md bg-primary/15 px-2 py-0.5 text-[11px] font-semibold text-primary",
								children: user ? "🟢 Cloud Sincronizzato" : "✨ Profilo Flow Locale"
							}), user?.primaryEmail && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "truncate text-xs text-muted",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "size-5 text-rose-400" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 font-heading text-lg font-bold text-fg",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							className: "flex flex-col items-center justify-center rounded-2xl bg-surface/80 p-3 ring-1 ring-border/50 hover:bg-elevated transition-colors text-center",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Music2, { className: "size-5 text-primary" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "mt-1 font-heading text-lg font-bold text-fg",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							className: "flex flex-col items-center justify-center rounded-2xl bg-surface/80 p-3 ring-1 ring-border/50 hover:bg-elevated transition-colors text-center",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-5 text-emerald-400" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "mt-1 font-heading text-lg font-bold text-fg",
									children: [listenHours, "h"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-[11px] text-muted",
									children: "Ascolto"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Incolla link da Spotify, YouTube o file M3U"
								})] })]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlidersVertical, { className: "size-4" })
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-semibold text-fg",
									children: "Equalizzatore & Audio Hi-Fi"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted",
									children: "Preset Bass Boost, Vocal, Rock, Pop"
								})] })]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-xs font-bold text-primary",
								children: "Regola"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center justify-between rounded-xl bg-surface p-3 ring-1 ring-border/50",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									className: "text-sm font-semibold text-fg",
									children: "Esporta Preferiti"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-muted",
									children: "Salva la tua libreria in formato M3U o CSV"
								})] })]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: `flex items-center justify-center gap-2 rounded-xl p-2.5 text-xs font-bold transition-all ${active ? "bg-primary text-primary-fg shadow-md shadow-primary/20" : "bg-surface text-muted hover:text-fg ring-1 ring-border/50"}`,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogOut, { className: "size-4" }), signingOut ? "Disconnessione..." : "Disconnetti Account"]
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/login",
						onClick: onClose,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogIn, { className: "size-4" }), "Accedi o Registrati con Account Cloud"]
					})
				})
			]
		})
...
function AuthChip() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		children: [user?.profileImageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			...
			className: "grid size-6 place-items-center rounded-full bg-gradient-to-tr from-primary to-emerald-400 text-[11px] font-bold text-bg",
			children: label.charAt(0).toUpperCase()
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "max-w-[7rem] truncate text-fg sm:max-w-[10rem]",
			children: label
		})]
...
function OnboardingModal() {
	...
	const [nameInput, setNameInput] = (0, import_react.useState)(profileName || "Flow User");
	const [selectedPreset, setSelectedPreset] = (0, import_react.useState)("all");
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative w-full max-w-md overflow-hidden rounded-3xl bg-[#14171E] p-6 text-fg shadow-2xl ring-1 ring-white/10 sm:p-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -right-16 -top-16 size-48 rounded-full bg-primary/20 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute -bottom-16 -left-16 size-48 rounded-full bg-emerald-500/15 blur-3xl" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative z-10 flex flex-col items-center text-center",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex size-16 items-center justify-center rounded-2xl bg-gradient-to-tr from-primary to-emerald-400 text-bg shadow-lg shadow-primary/25",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: "Benvenuto su Flow"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm text-muted",
							children: "Streaming audio ad alta fedeltà, testi karaoke sincronizzati, equalizer e importazione playlist da Spotify e YouTube."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-6 w-full space-y-1.5 text-left",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "text-xs font-semibold text-muted flex items-center gap-1.5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "size-3.5 text-primary" }), "Il tuo Nome Profilo"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "text",
								value: nameInput,
								onChange: (e) => setNameInput(e.target.value),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-5 grid w-full grid-cols-2 gap-2 text-left text-xs",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-xl bg-surface/80 p-3 ring-1 ring-border/50",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-semibold text-fg",
									children: "🎧 Background Audio"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-0.5 text-[11px] text-muted",
									children: "Ascolta a schermo spento senza interruzioni."
								})]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-xl bg-surface/80 p-3 ring-1 ring-border/50",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-semibold text-fg",
									children: "📥 Import Spotify"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "mt-0.5 text-[11px] text-muted",
									children: "Incolla link per salvare tutte le tue playlist."
								})]
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "size-4 fill-current" }), "Inizia ad Ascoltare"]
								...
								children: "Oppure accedi con un account"
							})]
						})
					]
				})
...
function QrModal() {
	...
	const qrUrl = `https://api.qrserver.com/v1/create-qr-code/?size=320x320&data=${encodeURIComponent(qrTarget.url)}&bgcolor=14171E&color=1ED760&margin=12&format=svg`;
	const handleCopy = () => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-center gap-2 text-primary font-heading text-sm font-bold uppercase tracking-wider",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QrCode, { className: "size-4" }), "Condivisione Rapida"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-4 flex flex-col items-center",
					children: [
						qrTarget.artwork && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "size-16 overflow-hidden rounded-2xl bg-surface shadow-lg ring-1 ring-white/10 mb-3",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackArt, {
								src: qrTarget.artwork,
								alt: qrTarget.title
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "max-w-[16rem] truncate text-base font-bold text-fg",
							children: qrTarget.title
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "max-w-[16rem] truncate text-xs text-muted mt-0.5",
							children: qrTarget.subtitle
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "relative mx-auto mt-4 size-56 overflow-hidden rounded-2xl bg-[#0e1015] p-3 shadow-inner ring-1 ring-primary/30 flex items-center justify-center",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: qrUrl,
						alt: "QR Code",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Smartphone, { className: "size-3.5 text-primary" }), "Inquadra con la fotocamera per aprire al volo"]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { className: "size-4 text-primary" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "size-4" }), copied ? "Copiato!" : "Copia Link"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: handleShare,
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Share2, { className: "size-4" }), "Condividi"]
					})]
				})
			]
		})
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "px-3 pb-[max(0.4rem,env(safe-area-inset-bottom))] pt-1 md:hidden",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
							className: "floating-nav flex items-center justify-around rounded-2xl border border-white/10 px-1 py-1 shadow-2xl",
							children: NAV.map((item) => {
								const active = item.to === "/" ? pathname === "/" : pathname.startsWith(item.to);
								const Icon = item.icon;
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: item.to,
									className: cn("floating-nav-pill flex min-h-12 flex-1 flex-col items-center justify-center gap-0.5 rounded-xl py-1 text-[11px] font-semibold transition-all", active ? "is-active text-primary" : "text-muted hover:text-fg"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: cn("size-5 transition-transform", active && "scale-110 text-primary") }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: cn("tracking-tight", active ? "font-bold text-fg" : "text-muted"),
										children: item.label
									})]
								}, item.to);
							})
...
var styles_default = "/assets/styles-B_1gKbzf.css";
var APP_NAME = "Flow";
...
var $$splitComponentImporter$15 = () => import("./routes-BgFXMaW2.mjs");
...
var $$splitComponentImporter$14 = () => import("./charts-DlLOGH0R.mjs");
...
var $$splitComponentImporter$13 = () => import("./discover-Ddz-5JJ8.mjs");
var Route$17 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./explore-dQvwFc0P.mjs");
...
var $$splitComponentImporter$7 = () => import("./mix-Dsg2qDnO.mjs");
...
var $$splitComponentImporter$6 = () => import("./radio-z-XQC0TR.mjs");
...
//#endregion
export { QuickTile as A, useCacheStats as B, androidBackgroundTips as C, isAppleMobile as D, isAndroid as E, canDownloadTrack as F, greetingIt as G, DEFAULT_SETTINGS as H, clearAllDownloads as I, useCurrentUserState as J, hashHue as K, downloadTracks as L, TrackArt as M, TrackCard as N, CollectionCard as O, TrackRow as P, publishPlaylist as Q, formatBytes as R, writeLastFmConfig as S, oemBatteryIntents as T, useFlowStore as U, useOfflineDownloads as V, cn as W, followUser as X, addSharedTrack as Y, listFriendsFeed as Z, tracksToM3u as _, Route$9 as a, lastFmHandshake as b, Route$12 as c, Route$19 as d, downloadText as f, tracksToCsv as g, slugFile as h, Route$3 as i, SectionHeader as j, HScroll as k, Route$16 as l, seedsToTracks as m, Route$1 as n, Route$10 as o, parsePlaylistFile as p, useCurrentUser as q, Route$2 as r, Route$11 as s, router_exports as t, Route$18 as u, unresolvedToText as v, detectOem as w, readLastFmConfig as x, EMPTY_LASTFM as y, removeDownload as z };
