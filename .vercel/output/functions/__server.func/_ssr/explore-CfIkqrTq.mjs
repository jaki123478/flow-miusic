...
import { a as Route$5, m as useFlowStore, p as TrackRow, u as SectionHeader } from "./router-CHLvWwov.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/explore-CfIkqrTq.js
var import_jsx_runtime = require_jsx_runtime();
function ExplorePage() {
	const { genre } = Route$5.useSearch();
	const selected = GENRES.find((g) => g.id === genre) || GENRES[0];
	const tracks = Route$5.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Generi e mood da YouTube Music, con testi SimpMusic."
			})] }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: GENRES.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/explore",
					search: { genre: g.id },
					className: `shrink-0 rounded-full px-4 py-2 text-sm font-medium ${g.id === selected.id ? "bg-primary text-primary-fg" : "bg-surface text-fg ring-1 ring-border"}`,
					children: g.name
				}, g.id))
			}),
