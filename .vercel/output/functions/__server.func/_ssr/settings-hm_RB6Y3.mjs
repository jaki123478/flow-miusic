...
import { F as DEFAULT_SETTINGS, I as useFlowStore, _ as detectOem, b as isAppleMobile, f as EMPTY_LASTFM, g as androidBackgroundTips, h as writeLastFmConfig, m as readLastFmConfig, p as lastFmHandshake, v as oemBatteryIntents, y as isAndroid } from "./router-3XRz9yob.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-hm_RB6Y3.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Riproduzione, aspetto, lingua e privacy."
			})] }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: ["dark", "light"].map((theme) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => set({ theme }),
							className: `h-9 rounded-full px-4 text-sm font-medium ${settings.theme === theme ? "bg-primary text-primary-fg" : "bg-elevated"}`,
							children: theme === "dark" ? "Scuro" : "Chiaro"
						}, theme))
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm font-medium",
						children: "Equalizzatore"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mb-3 text-xs text-muted",
						children: "Bassi e acuti sulla radio e sugli stream nativi."
					}),
