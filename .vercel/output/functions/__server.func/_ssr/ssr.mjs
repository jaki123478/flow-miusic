...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BqXGeCLS.mjs");
...
var manifest = {
	"02870f145ed293cf162bbe007ee1f2f3e2e84304ede96df4483cd43ae7997e20": {
		...
		importer: () => import("./catalog-DdsnJg0S.mjs")
	},
	...
	"8c6ad06ba8ef8e631af51a75efe1fcf89a937c103156b28c185e496e1e08a7b2": {
		...
		importer: () => import("./lyrics-DrMWXBp0.mjs")
	},
	...
	"ea6a09f743b9ccfc3ea1b144fd1fce5ad9dbc05c4b6411ca82670d5d56620830": {
		...
		importer: () => import("./import-playlists-DWYuxDwO.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CrM15VoK.mjs").then((n) => n.t),
