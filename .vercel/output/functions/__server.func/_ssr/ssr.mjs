...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DVtUbOgZ.mjs");
...
var manifest = {
	...
	"ea6a09f743b9ccfc3ea1b144fd1fce5ad9dbc05c4b6411ca82670d5d56620830": {
		...
		importer: () => import("./import-playlists-DNO3cYru.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CMLbHLRf.mjs").then((n) => n.t),
