...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-B7V3nYBz.js
				...
				children: [showLyrics ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: lyricsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("block w-full text-center leading-snug transition-all rounded-lg cursor-pointer", lyricsFontSize === "sm" ? isCur ? "text-lg font-bold py-1.5" : "text-sm py-1" : lyricsFontSize === "lg" ? isCur ? "text-2xl font-extrabold py-3" : "text-lg py-1.5" : lyricsFontSize === "xl" ? isCur ? "text-3xl font-black py-3.5" : "text-xl py-2" : isCur ? "text-xl font-extrabold py-2" : "text-base py-1.5", isCur ? "scale-105 text-primary" : i < activeIdx ? "text-fg/80 font-medium" : "text-muted/60 hover:text-fg/80"),
							children: line.text
						}, `${line.timeMs}-${i}`);
					})
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: cn("flex items-center gap-1 rounded-full bg-elevated/60 px-2.5 py-1 font-semibold hover:text-fg", (sleepEndsAt || sleepEndOfTrack) && "text-primary"),
										...
										className: "absolute bottom-9 right-0 z-50 min-w-44 rounded-xl bg-elevated/95 p-2 shadow-2xl backdrop-blur-md ring-1 ring-border text-xs space-y-1",
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												className: cn("block w-full rounded-lg px-2 py-1.5 text-left font-medium hover:bg-surface active:bg-primary active:text-primary-fg", sleepEndOfTrack && "text-primary font-bold"),
...
var styles_default = "/assets/styles-C5qoAVB9.css";
var APP_NAME = "Flow";
...
var $$splitComponentImporter$15 = () => import("./routes-CRYFNO--.mjs");
...
var $$splitComponentImporter$14 = () => import("./charts-BsQXFgLx.mjs");
...
var $$splitComponentImporter$13 = () => import("./discover-Db7yb8Kv.mjs");
var Route$17 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./explore-BrXIoBcl.mjs");
...
var $$splitComponentImporter$7 = () => import("./mix-BNNzhhMy.mjs");
...
var $$splitComponentImporter$6 = () => import("./radio-CX-24NGp.mjs");
