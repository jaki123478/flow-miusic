...
import { A as Heart, C as Mic, D as ListMusic, E as ListPlus, F as ChevronDown, I as Bot, M as Ellipsis, O as Library, P as Compass, S as Moon, _ as Repeat1, a as Trophy, b as Play, c as Sparkles, d as Shuffle, f as Share2, g as Repeat, h as Search, i as Volume2, j as Gauge, k as House, l as SkipForward, m as Send, n as VolumeX, o as TriangleAlert, p as Settings, r as VolumeOff, t as X, u as SkipBack, v as Radio, w as MicVocal, x as Pause, y as Plus } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/share-D7Hpy-Sj.js
/**
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-B9rxu5c1.js
...
function remember(track, recents, privateSession) {
...
function trimCache() {
	while (cache$1.size > 8) {
		const id = cache$1.keys().next().value;
		if (!id) break;
		const url = cache$1.get(id);
...
function prefetchAudio(id) {
	if (!id || cache$1.has(id) || inflight.has(id)) return;
	loadLocalAudio(id).catch(() => {});
}
async function loadLocalAudio(id) {
	const hit = cache$1.get(id);
	if (hit) return hit;
	const pending = inflight.get(id);
	if (pending) return pending;
	const job = withBackoff(async () => {
...
function AudioEngine() {
	...
	const wakeRef = (0, import_react.useRef)(null);
	const applySrc = (audio, src, play, force = false) => {
		if (!src) return;
		const going = !audio.paused && audio.currentTime > .4;
	...
	(0, import_react.useEffect)(() => {
		const kick = () => {
			...
			if (Date.now() - lastMove.current > 2500 && s.current.videoId && !String(audio.src).startsWith("blob:")) recover(s.current.videoId, t || s.currentTime);
		};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("audio", {
		...
		onPause: () => {
			if (useFlowStore.getState().isPlaying) audioRef.current?.play().catch(() => {});
		},
		onWaiting: () => {
			const s = useFlowStore.getState();
...
function LyricsView({ track, currentTime, onSeek }) {
	...
	const currentMs = currentTime * 1e3;
	const activeIndex = (0, import_react.useMemo)(() => {
		if (!lyrics || !lyrics.length) return -1;
		let idx = -1;
		for (let i = 0; i < lyrics.length; i++) if (lyrics[i].timeMs <= currentMs + 250) idx = i;
		else break;
		return idx;
	}, [lyrics, currentMs]);
	(0, import_react.useEffect)(() => {
		if (activeLineRef.current && scrollRef.current) activeLineRef.current.scrollIntoView({
			behavior: "smooth",
			block: "center"
		});
	}, [activeIndex]);
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex min-h-0 flex-1 flex-col items-center justify-center p-6 text-center text-muted",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "size-7 animate-spin rounded-full border-2 border-primary border-t-transparent" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "Caricamento testi sincronizzati (LRCLIB)…"
		})]
	});
	if (!lyrics || !lyrics.length) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex min-h-0 flex-1 flex-col items-center justify-center p-6 text-center text-muted",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicVocal, { className: "size-14 opacity-25" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Nessun testo trovato per questo brano. Riprova più tardi o cerca un'altra versione."
			})
		]
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		ref: scrollRef,
		className: "scrollbar-none min-h-0 flex-1 overflow-y-auto px-4 py-8 space-y-5 text-center",
		children: lyrics.map((line, idx) => {
			const isActive = idx === activeIndex;
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				ref: isActive ? activeLineRef : void 0,
				type: "button",
				onClick: () => onSeek(line.timeMs / 1e3),
				className: cn("block w-full py-2 transition-all rounded-lg cursor-pointer text-center select-none", isActive ? "scale-105 text-primary text-xl font-extrabold" : idx < activeIndex ? "text-fg/80 text-base font-medium" : "text-muted/50 text-base hover:text-fg/80"),
				children: line.text
			}, `${line.timeMs}-${idx}`);
		})
	});
...
function FullPlayer() {
	...
	const startRadioMix = async () => {
		...
		try {
			...
			if (related && related.length) playQueue([current, ...related], 0);
		} catch {}
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("player-full fixed inset-0 z-50 flex h-dvh flex-col bg-bg pt-[env(safe-area-inset-top)] overflow-hidden", open ? "is-open" : "is-closing"),
		role: "dialog",
		children: [
			current.artwork ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-gradient-to-b from-bg/60 via-bg/85 to-bg" })]
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-1 rounded-full bg-elevated/70 p-0.5 backdrop-blur-md",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => {
								...
								className: cn("rounded-full px-3 py-1 text-xs font-semibold transition-all", !showQueue && !showLyrics ? "bg-fg text-bg" : "text-muted hover:text-fg"),
								children: "Brano"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								...
								className: cn("flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold transition-all", showLyrics ? "bg-fg text-bg" : "text-muted hover:text-fg"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MicVocal, { className: "size-3" }), "Testi"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								type: "button",
								onClick: () => {
								...
								className: cn("flex items-center gap-1 rounded-full px-3 py-1 text-xs font-semibold transition-all", showQueue ? "bg-fg text-bg" : "text-muted hover:text-fg"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListMusic, { className: "size-3" }), "Coda"]
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("flex size-11 items-center justify-center rounded-full transition-colors hover:bg-elevated/60", sleepEndsAt ? "text-primary font-bold" : "text-muted"),
							"aria-label": "Sleep timer",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, { className: "size-5" })
						}), showSleepMenu ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "absolute right-0 top-12 z-50 min-w-36 rounded-xl bg-elevated/95 p-2 shadow-2xl backdrop-blur-md ring-1 ring-border text-xs space-y-1",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			showLyrics ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LyricsView, {
				track: current,
				currentTime,
				onSeek: seek
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mb-2 px-2 pt-2 text-xs font-semibold text-muted uppercase tracking-wider",
					children: [
						"In coda (",
						queue.length,
						" brani)"
				...
				className: "flex min-h-0 flex-1 flex-col justify-center px-6 pb-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mx-auto aspect-square w-[min(100%-2rem,22rem)] overflow-hidden rounded-2xl bg-elevated shadow-2xl ring-1 ring-white/10",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackArt, {
						src: current.artwork,
						alt: current.title
					})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 flex items-center justify-between border-t border-border/40 pt-3 text-xs text-muted",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: cycleRate,
...
function KeepAlive() {
	...
	(0, import_react.useEffect)(() => {
		...
		window.addEventListener("focus", kick);
		window.addEventListener("resume", kick);
		const t = window.setInterval(kick, 2e3);
		return () => {
			document.removeEventListener("visibilitychange", kick);
			window.removeEventListener("pageshow", kick);
			window.removeEventListener("focus", kick);
...
function AppShell({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(KeepAlive, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var styles_default = "/assets/styles-BJ5gc09c.css";
var APP_NAME = "Flow";
...
var $$splitComponentImporter$15 = () => import("./routes-DZSa2arh.mjs");
...
var $$splitComponentImporter$14 = () => import("./charts-BgfBK0bX.mjs");
...
var $$splitComponentImporter$13 = () => import("./discover-1J1mJ4pX.mjs");
var Route$17 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./explore-CPGkSvgk.mjs");
...
var $$splitComponentImporter$7 = () => import("./mix-icmFa-Jh.mjs");
...
var $$splitComponentImporter$6 = () => import("./radio-DxyyamNa.mjs");
...
//#endregion
export { followUser as A, TrackRow as C, greetingIt as D, cn as E, publishPlaylist as M, useCurrentUser as N, hashHue as O, useCurrentUserState as P, TrackCard as S, useFlowStore as T, CollectionCard as _, Route$9 as a, SectionHeader as b, Route$12 as c, Route$19 as d, androidBackgroundTips as f, isAppleMobile as g, isAndroid as h, Route$3 as i, listFriendsFeed as j, addSharedTrack as k, Route$16 as l, oemBatteryIntents as m, Route$1 as n, Route$10 as o, detectOem as p, Route$2 as r, Route$11 as s, router_exports as t, Route$18 as u, HScroll as v, DEFAULT_SETTINGS as w, TrackArt as x, QuickTile as y };
