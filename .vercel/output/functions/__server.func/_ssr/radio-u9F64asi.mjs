...
import { c as HScroll, f as TrackCard, m as useFlowStore, p as TrackRow, r as Route$2, u as SectionHeader, v as stationToTrack } from "./router-CHLvWwov.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/radio-u9F64asi.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function RadioPage() {
	const { c } = Route$2.useSearch();
	const navigate = Route$2.useNavigate();
	const { top, country } = Route$2.useLoaderData();
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionHeader, { title: "Per paese" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: RADIO_COUNTRIES.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `h-11 shrink-0 rounded-full px-4 text-sm font-medium ${item.code === code ? "bg-primary text-primary-fg" : "bg-surface text-fg ring-1 ring-border"}`,
					children: item.name
				}, item.code))
			})] }),
