...
import { m as useFlowStore, o as Route$6, p as TrackRow, u as SectionHeader } from "./router-CHLvWwov.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/charts-Cl1jcFcc.js
var import_jsx_runtime = require_jsx_runtime();
function ChartsPage() {
	const { id = "global" } = Route$6.useSearch();
	const navigate = Route$6.useNavigate();
	const chart = CHARTS.find((c) => c.id === id) || CHARTS[0];
	const tracks = Route$6.useLoaderData();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Hits da YouTube Music, aggiornate in tempo reale."
			})] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: CHARTS.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `h-11 shrink-0 rounded-full px-4 text-sm font-medium ${c.id === chart.id ? "bg-primary text-primary-fg" : "bg-surface text-fg ring-1 ring-border"}`,
					children: c.title
				}, c.id))
			}),
