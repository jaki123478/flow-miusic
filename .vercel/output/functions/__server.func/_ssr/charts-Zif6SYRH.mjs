...
import { F as TrackRow, M as SectionHeader, W as useFlowStore, d as Route$19 } from "./router-DXP7Hs_g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/charts-Zif6SYRH.js
var import_jsx_runtime = require_jsx_runtime();
function ChartsPage() {
	const { id = "global" } = Route$19.useSearch();
	const navigate = Route$19.useNavigate();
	const chart = CHARTS.find((c) => c.id === id) || CHARTS[0];
	const tracks = Route$19.useLoaderData();
