...
import { F as TrackRow, M as SectionHeader, W as useFlowStore, u as Route$17 } from "./router-DXP7Hs_g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/explore-DYrH4T1r.js
var import_jsx_runtime = require_jsx_runtime();
function ExplorePage() {
	const { genre } = Route$17.useSearch();
	const selected = GENRES.find((g) => g.id === genre) || GENRES[0];
	const tracks = Route$17.useLoaderData();
