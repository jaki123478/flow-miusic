...
//#region node_modules/.nitro/vite/services/ssr/assets/ytmusic.server-Dey1FpvL.js
...
function artistOf(item, subtitle) {
	...
	return parts.find((p) => !skip.test(p) && !/^\d/.test(p) && p.length < 60) || "YouTube Music";
}
...
//#endregion
export { getExploreTracks, getPlaylistTracks, searchYtMusic };
