...
import { b as LoaderCircle, s as Sparkles } from "../_libs/lucide-react.mjs";
import { g as createMoodMix, i as Route$3, m as useFlowStore, p as TrackRow, u as SectionHeader } from "./router-CHLvWwov.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/mix-BW5NLQ3B.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function MixPage() {
	const { mood: moodId } = Route$3.useSearch();
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: MOODS.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `h-11 rounded-full px-4 text-sm font-medium ${selected?.id === m.id ? "bg-primary text-primary-fg" : "bg-surface text-fg ring-1 ring-border"}`,
					children: m.label
				}, m.id))
			}),
