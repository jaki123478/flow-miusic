...
import { l as Route$13 } from "./router-DXP7Hs_g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-BHj7DAhT.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function Login() {
	const { mode: start, next } = Route$13.useSearch();
	const dest = next || "/";
